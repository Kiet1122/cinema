...
@section('content')
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-100 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl w-full">
        <!-- Card Container -->
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
            <!-- Left Side - Graphic/Image -->
            <div class="md:w-1/2 bg-gradient-to-br from-blue-600 to-indigo-700 p-12 flex flex-col justify-center text-white relative overflow-hidden">
                <!-- Background Pattern -->
            ...
            <div class="md:w-1/2 p-12 flex flex-col justify-center">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600 mt-2">Chào mừng trở lại hệ thống</p>
                </div>
                ...
                <form class="space-y-6" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <label for="remember" class="ml-3 text-sm text-gray-700 font-medium">Ghi nhớ đăng nhập</label>
                        </div>

                        @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-sm text-blue-600 hover:text-blue-500 font-semibold transition duration-300 hover:underline">
                            Quên mật khẩu?
                        </a>
                        @endif
                    </div>
                ...
                <div class="mt-8 pt-8 border-t border-gray-200">
                    <div class="text-center">
                        ...
                        <a href="{{ route('register') }}" class="text-blue-600 hover:text-blue-500 font-bold ml-2 transition duration-300 hover:underline text-lg">
                            Tạo tài khoản mới
                        </a>
                        @endif
                    </div>
